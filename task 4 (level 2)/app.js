...
keys.forEach((key) => {
  ...
  key.addEventListener('click', () => {
    ...
    if (getKeyContent === '=') {
      ...
      results.innerHTML = eval(display.value / 100); // divide the results by 100
      ...
      display.value = '0.'; // display an empty string if user clicks on /, *, -, + and . while there is no exiting value
